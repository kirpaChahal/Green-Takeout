            ...
            NavigationLink(
                ...
                label: {
                    Text("Start")
                        ...
                        .background(Color(#colorLiteral(red: 0.0580881, green: 0.90593573, blue: 0.3403331637, alpha: 1)))
                        .cornerRadius(10)
                })
            Spacer()
                                ...
                                NavigationLink(
                                    ...
                                    label: {
                                        Image(systemName: "arrow.right")
                                            ...
                                            .foregroundColor(Color(#colorLiteral(red: 0.0580881, green: 0.9593573, blue: 0.3403331637, alpha: 1)))
                                    })
        )
